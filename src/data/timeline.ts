...
export const experiences: ExperienceItem[] = [
  ...
  {
    company: "Háskóli Íslands (University of Iceland)",
    location: "Reykjavík, Iceland",
    ...
    roles: [
      {
        title: "Software Developer",
        period: "Dec 2020 – Jan 2021",
        highlights: ["Implemented GraphQL APIs (queries & mutations)"],
      },
    ],
  },
  {
    ...
    location: "Nepal",
    period: "Nov 2014 – Mar 2017 (2.5 years)",
    roles: [
      {
  ...
  },
  {
    ...
    location: "Nepal",
    period: "Nov 2013 – Oct 2014 (1 year)",
    roles: [
      {
  ...
  },
  {
    ...
    period: "Aug 2009 – June 2013 (4 year)",
    roles: [
      {
        title: "Bachelor's Student in Computer Engineering",
